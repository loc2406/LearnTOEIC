...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final CardLibraryAccessors laccForCardLibraryAccessors = new CardLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>card</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public CardLibraryAccessors getCard() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForCardLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class CardLibraryAccessors extends SubDependencyFactory {
        private final CardStackLibraryAccessors laccForCardStackLibraryAccessors = new CardStackLibraryAccessors(owner);

        public CardLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>card.stack</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CardStackLibraryAccessors getStack() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCardStackLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class CardStackLibraryAccessors extends SubDependencyFactory {

        public CardStackLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>view</b> with <b>com.yuyakaido.android:card-stack-view</b> coordinates and
         * with version reference <b>cardStackView</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class TextLibraryAccessors extends SubDependencyFactory {
        private final TextRecognitionLibraryAccessors laccForTextRecognitionLibraryAccessors = new TextRecognitionLibraryAccessors(owner);

        public TextLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>text.recognition</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TextRecognitionLibraryAccessors getRecognition() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTextRecognitionLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TextRecognitionLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public TextRecognitionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         * with version reference <b>textRecognitionChinese</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getKorean() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("text.recognition.korean");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>cardStackView</b> with value <b>2.3.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCardStackView() { return getVersion("cardStackView"); }
        ...
        /**
         * Version alias <b>converterGson</b> with value <b>2.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>converterScalars</b> with value <b>2.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesMlkitTextRecognitionCommon</b> with value <b>19.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>retrofit</b> with value <b>2.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>textRecognitionChinese</b> with value <b>16.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTextRecognitionChinese() { return getVersion("textRecognitionChinese"); }

        /**
         * Version alias <b>textRecognitionJapanese</b> with value <b>16.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTextRecognitionJapanese() { return getVersion("textRecognitionJapanese"); }

        /**
         * Version alias <b>textRecognitionKorean</b> with value <b>16.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTextRecognitionKorean() { return getVersion("textRecognitionKorean"); }
